...
export default function Home() {
  // State variable that tracks the list of current reviews
  const [reviews, setReviews] = useState([]);
  // State variable that tracks the title input
  const [title, setTitle] = useState("");
  // State variable that tracks the comment input
  const [comment, setComment] = useState("");
  // State variable that tracks the rating input
    ...
    <div>
      ...
      <main>
        <Container maxWidth="md">
          ...
          >
            <Button variant="contained" onClick={loadAllCurrentReviews}>
